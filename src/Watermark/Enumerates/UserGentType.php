...
namespace Dao\VideoClip\Watermark\Enumerates;
...
class UserGentType
{
     ...
     * windows下面的浏览器
     */
    const WIN_USER_AGENT = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.0.0 Safari/537.36";
